...
#define BitStream_Shift(_bs, _nbits)                                                            \
	do                                                                                          \
	{                                                                                           \
		if (_nbits == 0)                                                                        \
		{                                                                                       \
...
#define BitStream_GetRemainingLength(_bs) (_bs->length - _bs->position)
