...
#	define WINHTTP_FLAG_SECURE_PROTOCOL_ALL                                     \
		(WINHTTP_FLAG_SECURE_PROTOCOL_SSL2 | WINHTTP_FLAG_SECURE_PROTOCOL_SSL3 | \
...
#	define WINHTTP_CALLBACK_FLAG_RESOLVE_NAME \
		(WINHTTP_CALLBACK_STATUS_RESOLVING_NAME | WINHTTP_CALLBACK_STATUS_NAME_RESOLVED)
#	define WINHTTP_CALLBACK_FLAG_CONNECT_TO_SERVER \
...
#	define WINHTTP_CALLBACK_FLAG_INTERMEDIATE_RESPONSE \
...
#	define WINHTTP_CALLBACK_FLAG_ALL_COMPLETIONS                                             \
		(WINHTTP_CALLBACK_STATUS_SENDREQUEST_COMPLETE |                                       \
		 ...
		 WINHTTP_CALLBACK_STATUS_READ_COMPLETE | WINHTTP_CALLBACK_STATUS_WRITE_COMPLETE |     \
...
#	endif
	...
	WINPR_API BOOL WinHttpWriteData(HINTERNET hRequest, LPCVOID lpBuffer,
	...
	WINPR_API DWORD WinHttpIsHostInProxyBypassList(const WINHTTP_PROXY_INFO* pProxyInfo,
	                                               PCWSTR pwszHost, INTERNET_SCHEME tScheme,
	                                               INTERNET_PORT nPort, BOOL* pfIsInBypassList);

	WINPR_API WINHTTP_STATUS_CALLBACK
	WinHttpSetStatusCallback(HINTERNET hInternet, WINHTTP_STATUS_CALLBACK lpfnInternetCallback,
	                         DWORD dwNotificationFlags, DWORD_PTR dwReserved);

	WINPR_API HINTERNET WinHttpOpenRequest(HINTERNET hConnect, LPCWSTR pwszVerb,
	...
	WINPR_API BOOL WinHttpSendRequest(HINTERNET hRequest, LPCWSTR lpszHeaders,
	...
	WINPR_API BOOL WinHttpSetCredentials(HINTERNET hRequest, DWORD AuthTargets, DWORD AuthScheme,
	                                     LPCWSTR pwszUserName, LPCWSTR pwszPassword,
	                                     LPVOID pAuthParams);
	...
	WINPR_API BOOL WinHttpQueryAuthParams(HINTERNET hRequest, DWORD AuthScheme,
	                                      LPVOID* pAuthParams);
	...
	WINPR_API BOOL
	WinHttpGetIEProxyConfigForCurrentUser(WINHTTP_CURRENT_USER_IE_PROXY_CONFIG* pProxyConfig);
