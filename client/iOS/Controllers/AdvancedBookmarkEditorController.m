...
- (void)initAdvancedSettings:(NSIndexPath *)indexPath cell:(UITableViewCell *)cell {
	...
	{
		EditFlagTableViewCell *flagCell = (EditFlagTableViewCell *)cell;
		[[flagCell label] setText:NSLocalizedString(@"3G Settings",
	...
	case 3:
	{
		...
		[[selCell label]
		    setText:NSLocalizedString(@"3G Screen", @"'3G Screen': Bookmark 3G Screen settings")];
	...
	case 7:
	{
		EditTextTableViewCell *textCell = (EditTextTableViewCell *)cell;
		[[textCell label]
		    setText:NSLocalizedString(@"Working Directory",
...
- (void)toggleSettingValue:(id)sender {
	...
	case GET_TAG(SECTION_ADVANCED_SETTINGS, 0):
	{
		...
		NSArray *indexPaths = [NSArray
		    arrayWithObjects:[NSIndexPath indexPathForRow:1 inSection:SECTION_ADVANCED_SETTINGS],
		                     [NSIndexPath indexPathForRow:2 inSection:SECTION_ADVANCED_SETTINGS],
		                     nil];
	...
	case GET_TAG(SECTION_ADVANCED_SETTINGS, 2):
	{
		...
		NSArray *indexPaths = [NSArray
		    arrayWithObjects:[NSIndexPath indexPathForRow:3 inSection:SECTION_ADVANCED_SETTINGS],
		                     [NSIndexPath indexPathForRow:2 inSection:SECTION_ADVANCED_SETTINGS],
		                     nil];
		[[self tableView] reloadRowsAtIndexPaths:indexPaths
		                        withRowAnimation:UITableViewRowAnimationNone];
